import { $t as ExecuteToolModifiers, An as ToolRetrievalOptions, Cn as ToolList, Ln as ToolkitVersionParam, On as ToolProxyParams, X as McpServerGetResponse, _n as ToolExecuteMetaParams, at as ExecuteToolFnOptions, gn as Tool, hn as SchemaModifierOptions, n as BaseComposioProvider, nn as SessionExecuteMetaModifiers, r as BaseNonAgenticProvider, tn as ProviderOptions, tt as McpUrlResponse, wn as ToolListParams, xn as ToolExecuteResponse, yn as ToolExecuteParams } from "./BaseProvider-Brb3o86-.mjs";
import { D as Session, Dn as UpdateConnectedAccountAclParams, Ht as ConnectionRequest, M as SessionWithoutMcp, Vt as ComposioRequestOptions, an as ConnectedAccountRefreshOptions, bn as CreateConnectedAccountOptions, en as ConnectedAccountListParams, f as CustomToolkit, gn as CreateConnectedAccountLinkOptions, kn as UpdateConnectedAccountParams, nn as ConnectedAccountListResponse, o as CustomTool, q as ToolRouterSessionDeleteResponse, sn as ConnectedAccountRetrieveResponse, z as ToolRouterCreateSessionConfig } from "./customTool.types-D-6YqFdW.mjs";
import ComposioClient, { Composio } from "@composio/client";
import z$1, { z } from "zod/v3";
import { OpenAI } from "openai";
import { Files } from "#files";
import { ConnectedAccountDeleteResponse, ConnectedAccountPatchResponse, ConnectedAccountRefreshResponse, ConnectedAccountUpdateStatusParams, ConnectedAccountUpdateStatusResponse } from "@composio/client/resources/connected-accounts";
import { SessionExecuteParams } from "@composio/client/resources/tool-router/session/session.mjs";
...
declare class Tools<TToolCollection, TTool, TProvider extends BaseComposioProvider<TToolCollection, TTool, unknown>> {
   ...
   */
  private readonly warnedAutoUploadDisabledForTool;
   ...
   * ```
   */
  getRawComposioTools(query: ToolListParams, options?: SchemaModifierOptions, requestOptions?: ComposioRequestOptions): Promise<ToolList>;
  /**
   ...
   * ```
   */
  getRawToolRouterSessionTools(sessionId: string, options?: SchemaModifierOptions, requestOptions?: ComposioRequestOptions): Promise<ToolList>;
  /**
   ...
   * ```
   */
  getRawComposioToolBySlug(slug: string, options?: ToolRetrievalOptions, requestOptions?: ComposioRequestOptions): Promise<Tool>;
  /**
   ...
   * ```
   */
  get<T extends TProvider>(userId: string, filters: ToolListParams, options?: ProviderOptions<TProvider> & ComposioRequestOptions): Promise<ReturnType<T['wrapTools']>>;
  /**
   ...
   * ```
   */
  get<T extends TProvider>(userId: string, slug: string, options?: ProviderOptions<TProvider> & ComposioRequestOptions): Promise<ReturnType<T['wrapTools']>>;
  /**
   * @internal
   ...
   * ```
   */
  execute(slug: string, body: ToolExecuteParams, options?: ExecuteToolModifiers & ComposioRequestOptions): Promise<ToolExecuteResponse>;
  /**
   ...
   * @returns {Promise<ToolExecuteResponse>} The response from the tool execution
   */
  executeSessionTool(toolSlug: string, body: ToolExecuteMetaParams, modifiers?: SessionExecuteMetaModifiers, tool?: Tool, options?: ToolRouterSessionExecuteOptions, requestOptions?: ComposioRequestOptions): Promise<ToolExecuteResponse>;
  /**
   ...
   * ```
   */
  getToolsEnum(requestOptions?: ComposioRequestOptions): Promise<ToolRetrieveEnumResponse>;
  /**
   ...
   * ```
   */
  getInput(slug: string, body: ToolGetInputParams, requestOptions?: ComposioRequestOptions): Promise<ToolGetInputResponse>;
  /**
   ...
   * ```
   */
  proxyExecute(body: ToolProxyParams, requestOptions?: ComposioRequestOptions): Promise<ToolProxyResponse>;
}
//#endregion
 ...
 * Toolkit list params
 */
declare const ToolkitMangedByEnumSchema: z.ZodEnum<["all", "composio", "project"]>;
declare const ToolkitSortByEnumSchema: z.ZodEnum<["usage", "alphabetically"]>;
declare const ToolkitsListParamsSchema: z.ZodObject<{
  category: z.ZodOptional<z.ZodString>;
  managedBy: z.ZodOptional<z.ZodEnum<["all", "composio", "project"]>>;
  sortBy: z.ZodOptional<z.ZodEnum<["usage", "alphabetically"]>>;
...
type ToolkitMangedByEnum = z.infer<typeof ToolkitMangedByEnumSchema>;
type ToolkitSortByEnum = z.infer<typeof ToolkitSortByEnumSchema>;
type ToolkitListParams = z.infer<typeof ToolkitsListParamsSchema>;
/**
 * Toolkits response
 */
declare const ToolKitMetaSchema: z.ZodObject<{
  ...
  triggersCount: z.ZodOptional<z.ZodNumber>;
  updatedAt: z.ZodOptional<z.ZodString>;
  availableVersions: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
}, "strip", z.ZodTypeAny, {
...
declare const ToolKitItemSchema: z.ZodObject<{
  name: z.ZodString;
  slug: z.ZodString;
  meta: z.ZodObject<{
    categories: z.ZodOptional<z.ZodArray<z.ZodObject<{
  ...
  isLocalToolkit: z.ZodBoolean;
  authSchemes: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
  composioManagedAuthSchemes: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
...
declare const ToolKitListResponseSchema: z.ZodArray<z.ZodObject<{
  name: z.ZodString;
  slug: z.ZodString;
  meta: z.ZodObject<{
    categories: z.ZodOptional<z.ZodArray<z.ZodObject<{
...
type ToolKitMeta = z.infer<typeof ToolKitMetaSchema>;
type ToolKitItem = z.infer<typeof ToolKitItemSchema>;
type ToolKitListResponse = z.infer<typeof ToolKitListResponseSchema>;
/**
 * Toolkit retrieve response
 */
declare const ToolkitAuthFieldSchema: z.ZodObject<{
...
declare const ToolkitAuthConfigDetailsSchema: z.ZodObject<{
  name: z.ZodString;
  mode: z.ZodString;
  fields: z.ZodObject<{
    authConfigCreation: z.ZodObject<{
    ...
    connectedAccountInitiation: z.ZodObject<{
      optional: z.ZodArray<z.ZodObject<{
        description: z.ZodString;
        displayName: z.ZodString;
        required: z.ZodBoolean;
...
declare const ToolkitRetrieveResponseSchema: z.ZodObject<{
  name: z.ZodString;
  slug: z.ZodString;
  meta: z.ZodObject<{
    categories: z.ZodOptional<z.ZodArray<z.ZodObject<{
  ...
  isLocalToolkit: z.ZodBoolean;
  composioManagedAuthSchemes: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
  authConfigDetails: z.ZodOptional<z.ZodArray<z.ZodObject<{
    name: z.ZodString;
    mode: z.ZodString;
    fields: z.ZodObject<{
      authConfigCreation: z.ZodObject<{
  ...
  baseUrl: z.ZodOptional<z.ZodString>;
  getCurrentUserEndpoint: z.ZodOptional<z.ZodString>;
  getCurrentUserEndpointMethod: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
  slug: string;
  name: string;
  meta: {
...
type ToolkitAuthField = z.infer<typeof ToolkitAuthFieldSchema>;
type ToolkitAuthConfigDetails = z.infer<typeof ToolkitAuthConfigDetailsSchema>;
type ToolkitRetrieveResponse = z.infer<typeof ToolkitRetrieveResponseSchema>;
/**
 * Toolkit categories response
 */
declare const ToolkitCategorySchema: z.ZodObject<{
  id: z.ZodString;
  name: z.ZodString;
}, "strip", z.ZodTypeAny, {
  name: string;
...
declare const ToolkitRetrieveCategoriesResponseSchema: z.ZodObject<{
...
type ToolkitCategory = z.infer<typeof ToolkitCategorySchema>;
type ToolkitRetrieveCategoriesResponse = z.infer<typeof ToolkitRetrieveCategoriesResponseSchema>;
declare const ToolkitAuthFieldsResponseSchema: z.ZodArray<z.ZodObject<{
  description: z.ZodString;
  displayName: z.ZodString;
  name: z.ZodString;
  type: z.ZodString;
...
type ToolkitAuthFieldsResponse = z.infer<typeof ToolkitAuthFieldsResponseSchema>;
//#endregion
...
declare const AuthConfigCreationToolAccessConfigSchema: z.ZodObject<{
  toolsForConnectedAccountCreation: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
}, "strip", z.ZodTypeAny, {
  toolsForConnectedAccountCreation?: string[] | undefined;
}, {
  toolsForConnectedAccountCreation?: string[] | undefined;
}>;
declare const AuthConfigToolAccessConfigSchema: z.ZodObject<{
  toolsAvailableForExecution: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
  toolsForConnectedAccountCreation: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
}, "strip", z.ZodTypeAny, {
  toolsForConnectedAccountCreation?: string[] | undefined;
...
declare const AuthSchemeEnum: z.ZodEnum<["OAUTH2", "OAUTH1", "API_KEY", "BASIC", "BILLCOM_AUTH", "BEARER_TOKEN", "GOOGLE_SERVICE_ACCOUNT", "NO_AUTH", "BASIC_WITH_JWT", "CALCOM_AUTH", "SERVICE_ACCOUNT", "SAML", "DCR_OAUTH", "S2S_OAUTH2"]>;
declare const CreateCustomAuthConfigParamsSchema: z.ZodObject<{
  type: z.ZodLiteral<"use_custom_auth">;
  name: z.ZodOptional<z.ZodString>;
  credentials: z.ZodRecord<z.ZodString, z.ZodUnion<[z.ZodString, z.ZodNumber, z.ZodBoolean]>>;
  authScheme: z.ZodEnum<["OAUTH2", "OAUTH1", "API_KEY", "BASIC", "BILLCOM_AUTH", "BEARER_TOKEN", "GOOGLE_SERVICE_ACCOUNT", "NO_AUTH", "BASIC_WITH_JWT", "CALCOM_AUTH", "SERVICE_ACCOUNT", "SAML", "DCR_OAUTH", "S2S_OAUTH2"]>;
  proxyConfig: z.ZodOptional<z.ZodObject<{
    proxyUrl: z.ZodString;
    proxyAuthKey: z.ZodOptional<z.ZodString>;
  }, "strip", z.ZodTypeAny, {
    proxyUrl: string;
  ...
  toolAccessConfig: z.ZodOptional<z.ZodObject<{
    toolsForConnectedAccountCreation: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
  }, "strip", z.ZodTypeAny, {
    toolsForConnectedAccountCreation?: string[] | undefined;
  }, {
  ...
  isEnabledForToolRouter: z.ZodOptional<z.ZodBoolean>;
}, "strip", z.ZodTypeAny, {
...
declare const CreateComposioManagedAuthConfigParamsSchema: z.ZodObject<{
  type: z.ZodLiteral<"use_composio_managed_auth">;
  name: z.ZodOptional<z.ZodString>;
  credentials: z.ZodOptional<z.ZodObject<{
    scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
    user_scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
  ...
  name?: string | undefined;
  credentials?: z.objectOutputType<{
    scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
    user_scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
 ...
 */
declare const CreateAuthConfigParamsSchema: z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
  type: z.ZodLiteral<"use_custom_auth">;
  name: z.ZodOptional<z.ZodString>;
  credentials: z.ZodRecord<z.ZodString, z.ZodUnion<[z.ZodString, z.ZodNumber, z.ZodBoolean]>>;
  authScheme: z.ZodEnum<["OAUTH2", "OAUTH1", "API_KEY", "BASIC", "BILLCOM_AUTH", "BEARER_TOKEN", "GOOGLE_SERVICE_ACCOUNT", "NO_AUTH", "BASIC_WITH_JWT", "CALCOM_AUTH", "SERVICE_ACCOUNT", "SAML", "DCR_OAUTH", "S2S_OAUTH2"]>;
...
type CreateAuthConfigParams = z.infer<typeof CreateAuthConfigParamsSchema>;
declare const CreateAuthConfigResponseSchema: z.ZodObject<{
  id: z.ZodString;
...
type CreateAuthConfigResponse = z.infer<typeof CreateAuthConfigResponseSchema>;
declare const AuthConfigRetrieveResponseSchema: z.ZodObject<{
  id: z.ZodString;
  name: z.ZodString;
  toolkit: z.ZodObject<{
    logo: z.ZodString;
  ...
  expectedInputFields: z.ZodOptional<z.ZodArray<z.ZodUnknown, "many">>;
  isEnabledForToolRouter: z.ZodOptional<z.ZodBoolean>;
  /**
   * @deprecated - use tool access config to determine the tools that the user can perform on the auth config.
   */
  restrictToFollowingTools: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
  isComposioManaged: z.ZodOptional<z.ZodBoolean>;
...
type AuthConfigRetrieveResponse = z.infer<typeof AuthConfigRetrieveResponseSchema>;
declare const AuthConfigListParamsSchema: z.ZodObject<{
  cursor: z.ZodOptional<z.ZodString>;
  isComposioManaged: z.ZodOptional<z.ZodBoolean>;
  limit: z.ZodOptional<z.ZodNumber>;
...
type AuthConfigListParams = z.infer<typeof AuthConfigListParamsSchema>;
declare const AuthConfigListResponseSchema: z.ZodObject<{
  items: z.ZodArray<z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
    toolkit: z.ZodObject<{
...
type AuthConfigListResponse = z.infer<typeof AuthConfigListResponseSchema>;
declare const AuthCustomConfigUpdateParamsSchema: z.ZodObject<{
...
declare const AuthDefaultConfigUpdateParamsSchema: z.ZodObject<{
...
declare const AuthConfigUpdateParamsSchema: z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
  type: z.ZodLiteral<"custom">;
  credentials: z.ZodOptional<z.ZodObject<{
    scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
    user_scopes: z.ZodOptional<z.ZodUnion<[z.ZodString, z.ZodArray<z.ZodString, "many">]>>;
...
type AuthConfigUpdateParams = z.infer<typeof AuthConfigUpdateParamsSchema>;
//#endregion
...
declare class Toolkits {
   ...
   * @private
   */
  protected getToolkitBySlug(slug: string, requestOptions?: ComposioRequestOptions): Promise<ToolkitRetrieveResponse>;
  /**
   * Retrieves a specific toolkit by its slug identifier.
   *
   * @param {string} slug - The unique slug identifier of the toolkit to retrieve
   ...
   * ```
   */
  get(slug: string, requestOptions?: ComposioRequestOptions): Promise<ToolkitRetrieveResponse>;
  /**
   * Retrieves a list of toolkits based on the provided query parameters.
   *
   * @param {ToolkitListParams} query - The query parameters to filter toolkits
   ...
   * ```
   */
  get(query?: ToolkitListParams, requestOptions?: ComposioRequestOptions): Promise<ToolKitListResponse>;
   ...
   * ```
   */
  listCategories(requestOptions?: ComposioRequestOptions): Promise<ToolkitRetrieveCategoriesResponse>;
  /**
   ...
   *
   */
  authorize(userId: string, toolkitSlug: string, authConfigId?: string, requestOptions?: ComposioRequestOptions): Promise<ConnectionRequest>;
}
//#endregion
...
declare const TriggerStatusEnum: z.ZodEnum<["enable", "disable"]>;
declare const TriggerSubscribeParamSchema: z.ZodObject<{
  ...
  triggerSlug: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
...
type TriggerSubscribeParams = z.infer<typeof TriggerSubscribeParamSchema>;
declare const TriggerInstanceListActiveParamsSchema: z.ZodObject<{
  authConfigIds: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
  connectedAccountIds: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
  limit: z.ZodOptional<z.ZodNumber>;
  cursor: z.ZodOptional<z.ZodString>;
  showDisabled: z.ZodOptional<z.ZodNullable<z.ZodBoolean>>;
  triggerIds: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
  triggerNames: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
}, "strip", z.ZodTypeAny, {
  limit?: number | undefined;
...
type TriggerInstanceListActiveParams = z.infer<typeof TriggerInstanceListActiveParamsSchema>;
declare const TriggerInstanceListActiveResponseItemSchema: z.ZodObject<{
  id: z.ZodString;
...
declare const TriggerInstanceListActiveResponseSchema: z.ZodObject<{
  items: z.ZodArray<z.ZodObject<{
    id: z.ZodString;
    connectedAccountId: z.ZodString;
    disabledAt: z.ZodNullable<z.ZodString>;
...
type TriggerInstanceListActiveResponse = z.infer<typeof TriggerInstanceListActiveResponseSchema>;
type TriggerInstanceListActiveResponseItem = z.infer<typeof TriggerInstanceListActiveResponseItemSchema>;
declare const TriggerInstanceUpsertParamsSchema: z.ZodObject<{
  connectedAccountId: z.ZodOptional<z.ZodString>;
...
type TriggerInstanceUpsertParams = z.infer<typeof TriggerInstanceUpsertParamsSchema>;
declare const TriggerInstanceUpsertResponseSchema: z.ZodObject<{
...
type TriggerInstanceUpsertResponse = z.infer<typeof TriggerInstanceUpsertResponseSchema>;
declare const TriggerInstanceManageUpdateParamsSchema: z.ZodObject<{
  status: z.ZodEnum<["enable", "disable"]>;
}, "strip", z.ZodTypeAny, {
  status: "disable" | "enable";
}, {
  status: "disable" | "enable";
}>;
type TriggerInstanceManageUpdateParams = z.infer<typeof TriggerInstanceManageUpdateParamsSchema>;
declare const TriggerInstanceManageUpdateResponseSchema: z.ZodObject<{
...
type TriggerInstanceManageUpdateResponse = z.infer<typeof TriggerInstanceManageUpdateResponseSchema>;
declare const TriggerInstanceManageDeleteResponseSchema: z.ZodObject<{
  triggerId: z.ZodString;
}, "strip", z.ZodTypeAny, {
  triggerId: string;
}, {
...
type TriggerInstanceManageDeleteResponse = z.infer<typeof TriggerInstanceManageDeleteResponseSchema>;
declare const IncomingTriggerPayloadSchema: z.ZodObject<{
  id: z.ZodString;
  uuid: z.ZodString;
  triggerSlug: z.ZodString;
  toolkitSlug: z.ZodString;
  userId: z.ZodString;
  payload: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
  originalPayload: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
  metadata: z.ZodObject<{
    ...
    triggerData: z.ZodOptional<z.ZodString>;
    triggerConfig: z.ZodRecord<z.ZodString, z.ZodUnknown>;
    connectedAccount: z.ZodObject<{
      id: z.ZodString;
      uuid: z.ZodString;
      authConfigId: z.ZodString;
      authConfigUUID: z.ZodString;
      userId: z.ZodString;
...
type IncomingTriggerPayload = z.infer<typeof IncomingTriggerPayloadSchema>;
type TriggerData = {
  appName: string;
  clientId: number;
...
declare const TriggersTypeListParamsSchema: z.ZodObject<{
  cursor: z.ZodOptional<z.ZodString>;
  limit: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
  toolkits: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodString, "many">>>;
}, "strip", z.ZodTypeAny, {
...
type TriggersTypeListParams = z.infer<typeof TriggersTypeListParamsSchema>;
declare const TriggerTypeSchema: z.ZodObject<{
  slug: z.ZodString;
  name: z.ZodString;
  description: z.ZodString;
...
declare const TriggersTypeListResponseSchema: z.ZodObject<{
  items: z.ZodArray<z.ZodObject<{
    slug: z.ZodString;
    name: z.ZodString;
    description: z.ZodString;
...
type TriggersTypeListResponse = z.infer<typeof TriggersTypeListResponseSchema>;
type TriggersTypeRetrieveResponse = z.infer<typeof TriggerTypeSchema>;
/**
...
declare const WebhookPayloadV1Schema: z.ZodObject<{
...
type WebhookPayloadV1 = z.infer<typeof WebhookPayloadV1Schema>;
/** V2 webhook payload - includes timestamp and nested data */
declare const WebhookPayloadV2Schema: z.ZodObject<{
  type: z.ZodString;
  timestamp: z.ZodString;
  log_id: z.ZodString;
  data: z.ZodObject<{
    connection_id: z.ZodString;
    connection_nano_id: z.ZodString;
    trigger_nano_id: z.ZodString;
    trigger_id: z.ZodString;
    user_id: z.ZodString;
  }, "passthrough", z.ZodTypeAny, z.objectOutputType<{
    connection_id: z.ZodString;
...
type WebhookPayloadV2 = z.infer<typeof WebhookPayloadV2Schema>;
/** V3 webhook payload - generic envelope for all composio.* events */
declare const WebhookPayloadV3Schema: z.ZodObject<{
  id: z.ZodString;
  timestamp: z.ZodString;
...
type WebhookPayloadV3 = z.infer<typeof WebhookPayloadV3Schema>;
/** V3 trigger-specific payload - has trigger metadata fields */
declare const WebhookTriggerPayloadV3Schema: z.ZodObject<{
  id: z.ZodString;
  timestamp: z.ZodString;
  type: z.ZodString;
  metadata: z.ZodObject<{
    log_id: z.ZodString;
    trigger_slug: z.ZodString;
    trigger_id: z.ZodString;
    connected_account_id: z.ZodString;
    auth_config_id: z.ZodString;
    user_id: z.ZodString;
  }, "passthrough", z.ZodTypeAny, z.objectOutputType<{
    log_id: z.ZodString;
    trigger_slug: z.ZodString;
...
type WebhookTriggerPayloadV3 = z.infer<typeof WebhookTriggerPayloadV3Schema>;
/** Union of all webhook payload versions */
declare const WebhookPayloadSchema: z.ZodUnion<[z.ZodObject<{
  id: z.ZodString;
  timestamp: z.ZodString;
  type: z.ZodEffects<z.ZodString, string, string>;
  metadata: z.ZodRecord<z.ZodString, z.ZodUnknown>;
...
declare const DefaultWebhookSubscriptionEvents: readonly ["composio.trigger.message"];
declare const SetWebhookSubscriptionParamsSchema: z.ZodObject<{
  /** HTTPS URL to receive webhook events. */webhookUrl: z.ZodString; /** Event types to subscribe to. Defaults to trigger messages. */
  enabledEvents: z.ZodOptional<z.ZodArray<z.ZodString, "many">>; /** Webhook payload version. Defaults to V3. */
  version: z.ZodOptional<z.ZodEnum<["V1", "V2", "V3"]>>;
}, "strip", z.ZodTypeAny, {
  webhookUrl: string;
...
type SetWebhookSubscriptionParams = z.infer<typeof SetWebhookSubscriptionParamsSchema>;
 ...
 */
declare const VerifyWebhookParamsSchema: z.ZodObject<{
  /**
   * The webhook message ID from the 'webhook-id' header.
   * Format: 'msg_xxx'
   */
  id: z.ZodString; /** The raw webhook payload as a string (request body) */
  payload: z.ZodString; /** The webhook secret used to sign the payload (from Composio dashboard) */
  secret: z.ZodString;
  /**
...
type VerifyWebhookParams = z.input<typeof VerifyWebhookParamsSchema>;
/**
 ...
 */
type WebhookRequestLike = Request | {
  body: unknown;
  headers: unknown;
};
/**
...
type VerifyWebhookResult = {
  /** The webhook version (V1, V2, or V3), from 'x-composio-webhook-version' */version: WebhookVersion; /** The parsed and normalized webhook payload */
  payload: IncomingTriggerPayload; /** The raw parsed payload before normalization */
...
declare class Triggers<TProvider extends BaseComposioProvider<unknown, unknown, unknown>> {
   ...
   * ```
   */
  setWebhookSubscription(params: SetWebhookSubscriptionParams): Promise<WebhookSubscription>;
  /**
   ...
   * ```
   */
  listActive(query?: TriggerInstanceListActiveParams, requestOptions?: ComposioRequestOptions): Promise<TriggerInstanceListActiveResponse>;
  /**
   ...
   */
  create(userId: string, slug: string, body?: TriggerInstanceUpsertParams, requestOptions?: ComposioRequestOptions): Promise<TriggerInstanceUpsertResponse>;
  /**
   ...
   */
  update(triggerId: string, body: TriggerInstanceManageUpdateParams, requestOptions?: ComposioRequestOptions): Promise<TriggerInstanceManageUpdateResponse>;
  /**
   ...
   * @returns
   */
  delete(triggerId: string, requestOptions?: ComposioRequestOptions): Promise<TriggerInstanceManageDeleteResponse>;
  /**
   ...
   */
  disable(triggerId: string, requestOptions?: ComposioRequestOptions): Promise<ComposioClient.TriggerInstances.Manage.ManageUpdateResponse>;
  /**
   ...
   * @returns {Promise<TriggerInstanceUpsertResponse>} The updated trigger instance
   */
  enable(triggerId: string, requestOptions?: ComposioRequestOptions): Promise<ComposioClient.TriggerInstances.Manage.ManageUpdateResponse>;
  /**
   ...
   */
  listTypes(query?: TriggersTypeListParams, requestOptions?: ComposioRequestOptions): Promise<TriggersTypeListResponse>;
  /**
   ...
   */
  getType(slug: string, requestOptions?: ComposioRequestOptions): Promise<TriggersTypeRetrieveResponse>;
  /**
   ...
   * @returns
   */
  listEnum(requestOptions?: ComposioRequestOptions): Promise<TriggersTypeRetrieveEnumResponse>;
  /**
   ...
   * ```
   */
  parse(request: WebhookRequestLike, options?: ParseWebhookOptions): Promise<VerifyWebhookResult>;
  /**
...
declare class AuthConfigs {
   ...
   * ```
   */
  list(query?: AuthConfigListParams, requestOptions?: ComposioRequestOptions): Promise<AuthConfigListResponse>;
  /**
   ...
   */
  create(toolkit: string, options?: CreateAuthConfigParams, requestOptions?: ComposioRequestOptions): Promise<CreateAuthConfigResponse>;
  /**
   ...
   * ```
   */
  get(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<AuthConfigRetrieveResponse>;
  /**
   ...
   * ```
   */
  update(nanoid: string, data: AuthConfigUpdateParams, requestOptions?: ComposioRequestOptions): Promise<AuthConfigUpdateResponse>;
  /**
   ...
   * ```
   */
  delete(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<AuthConfigDeleteResponse>;
  /**
   ...
   * ```
   */
  updateStatus(status: 'ENABLED' | 'DISABLED', nanoid: string, requestOptions?: ComposioRequestOptions): Promise<AuthConfigUpdateStatusResponse>;
  /**
   ...
   * ```
   */
  enable(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<AuthConfigUpdateStatusResponse>;
  /**
   ...
   * ```
   */
  disable(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<AuthConfigUpdateStatusResponse>;
}
//#endregion
...
declare class ConnectedAccounts {
   ...
   * ```
   */
  list(query?: ConnectedAccountListParams, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountListResponse>;
  /**
   ...
   */
  initiate(userId: string, authConfigId: string, options?: CreateConnectedAccountOptions, requestOptions?: ComposioRequestOptions): Promise<ConnectionRequest>;
  /**
   ...
   * ```
   */
  link(userId: string, authConfigId: string, options?: CreateConnectedAccountLinkOptions, requestOptions?: ComposioRequestOptions): Promise<ConnectionRequest>;
  /**
   ...
   * ```
   */
  get(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountRetrieveResponse>;
  /**
   ...
   * ```
   */
  delete(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountDeleteResponse>;
  /**
   ...
   * ```
   */
  refresh(nanoid: string, options?: ConnectedAccountRefreshOptions, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountRefreshResponse>;
  /**
   ...
   * ```
   */
  updateStatus(nanoid: string, params: ConnectedAccountUpdateStatusParams, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountUpdateStatusResponse>;
  /**
   * Enable a connected account
   * @param {string} nanoid - Unique identifier of the connected account
   * @returns {Promise<ConnectedAccountUpdateStatusResponse>} Updated connected account details
   ...
   * ```
   */
  enable(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountUpdateStatusResponse>;
  /**
   ...
   * ```
   */
  disable(nanoid: string, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountUpdateStatusResponse>;
  /**
   ...
   * ```
   */
  updateAcl(nanoid: string, params: UpdateConnectedAccountAclParams): Promise<ConnectedAccountPatchResponse>;
  /**
   ...
   * ```
   */
  update(nanoid: string, params: UpdateConnectedAccountParams, requestOptions?: ComposioRequestOptions): Promise<ConnectedAccountUpdateStatusResponse>;
}
//#endregion
//#region src/models/Experimental.d.ts
...
declare const MCPServerInstanceSchema: z$1.ZodObject<{
  id: z$1.ZodString;
  name: z$1.ZodString;
  type: z$1.ZodLiteral<"streamable_http">;
  url: z$1.ZodString;
  userId: z$1.ZodString;
  allowedTools: z$1.ZodArray<z$1.ZodString, "many">;
  authConfigs: z$1.ZodArray<z$1.ZodString, "many">;
...
type MCPServerInstance = z$1.infer<typeof MCPServerInstanceSchema>;
declare const MCPConfigCreationParamsSchema: z$1.ZodObject<{
  toolkits: z$1.ZodArray<z$1.ZodUnion<[z$1.ZodObject<{
  ...
  allowedTools: z$1.ZodOptional<z$1.ZodArray<z$1.ZodString, "many">>;
  manuallyManageConnections: z$1.ZodOptional<z$1.ZodDefault<z$1.ZodBoolean>>;
}, "strip", z$1.ZodTypeAny, {
  toolkits: (string | {
    toolkit?: string | undefined;
    authConfigId?: string | undefined;
...
type MCPConfigCreationParams = z$1.infer<typeof MCPConfigCreationParamsSchema>;
declare const MCPConfigResponseSchema: z$1.ZodObject<{
  /**
   ...
   */
  authConfigIds: z$1.ZodArray<z$1.ZodString, "many">;
  /**
...
type MCPConfigResponse = z$1.infer<typeof MCPConfigResponseSchema>;
...
declare const MCPGetInstanceParamsSchema: z$1.ZodObject<{
  manuallyManageConnections: z$1.ZodOptional<z$1.ZodDefault<z$1.ZodBoolean>>;
}, "strip", z$1.ZodTypeAny, {
  manuallyManageConnections?: boolean | undefined;
}, {
...
type MCPGetInstanceParams = z$1.infer<typeof MCPGetInstanceParamsSchema>;
declare const MCPListParamsSchema: z$1.ZodObject<{
  page: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodNumber>>;
  limit: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodNumber>>;
  toolkits: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodArray<z$1.ZodString, "many">>>;
  authConfigs: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodArray<z$1.ZodString, "many">>>;
...
type MCPListParams = z$1.infer<typeof MCPListParamsSchema>;
declare const MCPItemSchema: z$1.ZodObject<{
  /**
   * Unique identifier for the newly created custom MCP server
   */
  id: z$1.ZodString;
  ...
  toolkitIcons: z$1.ZodRecord<z$1.ZodString, z$1.ZodString>;
  serverInstanceCount: z$1.ZodNumber;
...
type MCPItem = z$1.infer<typeof MCPItemSchema>;
declare const MCPListResponseSchema: z$1.ZodObject<{
...
type MCPListResponse = z$1.infer<typeof MCPListResponseSchema>;
declare const MCPUpdateParamsSchema: z$1.ZodObject<{
  name: z$1.ZodOptional<z$1.ZodString>;
  toolkits: z$1.ZodOptional<z$1.ZodArray<z$1.ZodUnion<[z$1.ZodObject<{
    toolkit: z$1.ZodOptional<z$1.ZodString>;
    authConfigId: z$1.ZodOptional<z$1.ZodString>;
  }, "strip", z$1.ZodTypeAny, {
    toolkit?: string | undefined;
  ...
  allowedTools: z$1.ZodOptional<z$1.ZodArray<z$1.ZodString, "many">>;
  manuallyManageConnections: z$1.ZodOptional<z$1.ZodBoolean>;
}, "strip", z$1.ZodTypeAny, {
  name?: string | undefined;
  toolkits?: (string | {
    toolkit?: string | undefined;
...
type MCPUpdateParams = z$1.infer<typeof MCPUpdateParamsSchema>;
//#endregion
...
declare class MCP {
   ...
   * ```
   */
  create(name: string, mcpConfig: MCPConfigCreationParams, requestOptions?: ComposioRequestOptions): Promise<MCPConfigCreateResponse>;
  /**
   ...
   * ```
   */
  list(options: MCPListParams, requestOptions?: ComposioRequestOptions): Promise<MCPListResponse>;
  /**
   ...
   */
  get(serverId: string, requestOptions?: ComposioRequestOptions): Promise<MCPItem>;
  /**
   ...
   */
  delete(serverId: string, requestOptions?: ComposioRequestOptions): Promise<{
    id: string;
    deleted: boolean;
  }>;
  /**
   ...
   */
  update(serverId: string, config: MCPUpdateParams, requestOptions?: ComposioRequestOptions): Promise<MCPItem>;
  /**
   ...
   */
  generate(userId: string, mcpConfigId: string, options?: MCPGetInstanceParams, requestOptions?: ComposioRequestOptions): Promise<MCPServerInstance>;
}
//#endregion
...
declare class ToolRouter<TToolCollection, TTool, TProvider extends BaseComposioProvider<TToolCollection, TTool, unknown>> {
   ...
   * ```
   */
  create(userId: string, config: ToolRouterCreateSessionConfig & {
    mcp: true;
  }, requestOptions?: ComposioRequestOptions): Promise<Session<TToolCollection, TTool, TProvider>>;
  create(userId: string, config?: ToolRouterCreateSessionConfig, requestOptions?: ComposioRequestOptions): Promise<SessionWithoutMcp<TToolCollection, TTool, TProvider>>;
  /**
  ...
  use(id: string, options?: {
    ...
    customToolkits?: CustomToolkit[];
    mcp?: boolean;
  }, requestOptions?: ComposioRequestOptions): Promise<SessionWithoutMcp<TToolCollection, TTool, TProvider>>;
  /**
   ...
   */
  delete(id: string, requestOptions?: ComposioRequestOptions): Promise<ToolRouterSessionDeleteResponse>;
}
//#endregion
//#region src/models/Sessions.d.ts
/**
 ...
 */
declare class Sessions<TToolCollection, TTool, TProvider extends BaseComposioProvider<TToolCollection, TTool, unknown>> extends ToolRouter<TToolCollection, TTool, TProvider> {
  constructor(client: Composio, config?: ComposioConfig<TProvider>);
}
//#endregion
...
//#endregion
export { WebhookPayloadV3 as $, ToolkitsListParamsSchema as $t, TriggerInstanceUpsertResponse as A, ToolKitItem as At, TriggersTypeListParamsSchema as B, ToolkitAuthFieldsResponse as Bt, TriggerInstanceManageDeleteResponseSchema as C, AuthSchemeTypes as Ct, TriggerInstanceManageUpdateResponseSchema as D, CreateAuthConfigResponseSchema as Dt, TriggerInstanceManageUpdateResponse as E, CreateAuthConfigResponse as Et, TriggerSubscribeParamSchema as F, ToolKitMetaSchema as Ft, VerifyWebhookParamsSchema as G, ToolkitMangedByEnum as Gt, TriggersTypeListResponseSchema as H, ToolkitCategory as Ht, TriggerSubscribeParams as I, ToolkitAuthConfigDetails as It, WebhookPayloadSchema as J, ToolkitRetrieveCategoriesResponseSchema as Jt, VerifyWebhookResult as K, ToolkitMangedByEnumSchema as Kt, TriggerType as L, ToolkitAuthConfigDetailsSchema as Lt, TriggerStatusEnum as M, ToolKitListResponse as Mt, TriggerStatusType as N, ToolKitListResponseSchema as Nt, TriggerInstanceUpsertParams as O, CreateComposioManagedAuthConfigParamsSchema as Ot, TriggerStatuses as P, ToolKitMeta as Pt, WebhookPayloadV2Schema as Q, ToolkitSortByEnumSchema as Qt, TriggerTypeSchema as R, ToolkitAuthField as Rt, TriggerInstanceManageDeleteResponse as S, AuthSchemeType as St, TriggerInstanceManageUpdateParamsSchema as T, CreateAuthConfigParamsSchema as Tt, TriggersTypeRetrieveResponse as U, ToolkitCategorySchema as Ut, TriggersTypeListResponse as V, ToolkitAuthFieldsResponseSchema as Vt, VerifyWebhookParams as W, ToolkitListParams as Wt, WebhookPayloadV1Schema as X, ToolkitRetrieveResponseSchema as Xt, WebhookPayloadV1 as Y, ToolkitRetrieveResponse as Yt, WebhookPayloadV2 as Z, ToolkitSortByEnum as Zt, TriggerInstanceListActiveParamsSchema as _, AuthConfigUpdateParams as _t, MCP as a, WebhookVersion as at, TriggerInstanceListActiveResponseItemSchema as b, AuthDefaultConfigUpdateParamsSchema as bt, IncomingTriggerPayload as c, AuthConfigListParams as ct, SetWebhookSubscriptionParams as d, AuthConfigListResponseSchema as dt, WebhookPayloadV3Schema as et, SetWebhookSubscriptionParamsSchema as f, AuthConfigRetrieveResponse as ft, TriggerInstanceListActiveParams as g, AuthConfigTypes as gt, TriggerEventData as h, AuthConfigType as ht, OpenAIProvider as i, WebhookTriggerPayloadV3Schema as it, TriggerInstanceUpsertResponseSchema as j, ToolKitItemSchema as jt, TriggerInstanceUpsertParamsSchema as k, CreateCustomAuthConfigParamsSchema as kt, IncomingTriggerPayloadSchema as l, AuthConfigListParamsSchema as lt, TriggerEvent as m, AuthConfigToolAccessConfigSchema as mt, ComposioConfig as n, WebhookSubscription as nt, Experimental as o, WebhookVersions as ot, TriggerData as p, AuthConfigRetrieveResponseSchema as pt, WebhookPayload as q, ToolkitRetrieveCategoriesResponse as qt, Sessions as r, WebhookTriggerPayloadV3 as rt, DefaultWebhookSubscriptionEvents as s, AuthConfigCreationToolAccessConfigSchema as st, Composio$1 as t, WebhookRequestLike as tt, ParseWebhookOptions as u, AuthConfigListResponse as ut, TriggerInstanceListActiveResponse as v, AuthConfigUpdateParamsSchema as vt, TriggerInstanceManageUpdateParams as w, CreateAuthConfigParams as wt, TriggerInstanceListActiveResponseSchema as x, AuthSchemeEnum as xt, TriggerInstanceListActiveResponseItem as y, AuthCustomConfigUpdateParamsSchema as yt, TriggersTypeListParams as z, ToolkitAuthFieldSchema as zt };