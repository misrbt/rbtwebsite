import { a as ComposioSensitiveFilePathBlockedError, c as logger, i as ComposioFileUploadPathNotAllowedError, l as COMPOSIO_DIR, m as TEMP_FILES_DIRECTORY_NAME, t as ComposioFileNotFoundError } from "./FileModifierErrors-3fSwIWoa.mjs";
import { i as getRandomShortId, n as base64ToUint8Array, r as uint8ArrayToBase64 } from "./buffer-PcbMMsgm.mjs";
...
const readFile = async (file, signal) => {
	...
	} else if (typeof file === "string") if (file.startsWith("http")) return await readFileContentFromURL(file, signal);
